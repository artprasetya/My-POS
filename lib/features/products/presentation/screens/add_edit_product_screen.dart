    ...
    try {
      ...
      if (_isEdit) {
        context.read<ProductBloc>().add(ProductUpdateRequested(
          ...
          imageName: _imageFile != null ? '${DateTime.now().millisecondsSinceEpoch}.jpg' : null,
        ));
      } else {
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: _isUploading ? null : (v) => setState(() => _selectedCategoryId = v),
